    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-12 text-center">
                <a href="cars"><h3 class="fw-semibold display-6 text-uppercase text-primary">My Cars</h3></a>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-12">
                <form method="get" action="my_cars" autocomplete="off">
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
                <div class="bg-white rounded-3 shadow-sm">
                    ...
                    <div class="card-custom-content p-4">
                        ...
                        <div class="mt-4">
                            <a href="<?php echo 'edit_car?car=' . $row[3]; ?>" class="btn btn-primary rounded-3 w-100 mb-2 text-uppercase fw-semibold">Edit</a>
            ...
            <div class="col-12 mt-5">
                <nav>
                    ...
                    for ($i = 1; $i <= $number_of_pages; $i++) {
                        ...
                        echo '<li class="page-item ' . $active . '"><a class="page-link" href="my_cars?page=' . $i . '">' . $i . '</a></li>';
                    }
                    ?>
                    </ul>
                </nav>
